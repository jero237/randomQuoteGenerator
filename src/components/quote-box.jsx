const QuoteBox = (props) => {
    return (
        <div id="quote-box">
            ...
            <div id="buttons">
                <a id="tweet-quote" target="_blank" rel="noreferrer" href={'https://twitter.com/intent/tweet?text="' + encodeURIComponent(props.quote) + '" - ' + encodeURIComponent(props.author)} className="button" style={{backgroundColor: props.color, transition: "background-color 1s, transform .2s"}}><i className="fab fa-twitter fa-lg"></i></a>
